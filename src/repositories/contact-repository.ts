...
class ContactRepository {
  ...
  list(opts: Partial<SkipTake> = {}): AsyncResult<PaginatedResult<ContactMessage>> {
    return this.db.run(
      'contact-repo.list',
      Promise.all([
